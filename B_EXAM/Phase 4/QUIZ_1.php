    ...
    <div id="wrapper">
        <div class="main">
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse">
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li><a href="A_LOGIN/1_COURSE.html">Join Course</a></li>
                            <li><a href="A_LOGIN/6_TEMPLATES.html">Templates</a></li>
                            <li><a href="A_LOGIN/5_COMPILER.html">Compiler</a></li>
            ...
            <section class="jumbotron">
                <div class="container">
                    <p><center><img src="PHASES/PHP1.png" height="150" width="150"></center></p>
                    <p class="lead"><center><b><h3>Welcome to Phase 4 : PHP</h3></b></center></p>
                </div>
            </section>
                ...
                <?php 															
																...
																$fetchqry2 = "UPDATE `p4q1` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table class="roundedCorners1" align="center"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `p4q1` where id='$c'"; 
...
<tr align="center"><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
 ...
 <?php if($_SESSION['clicks']>10){ 
	$qry3 = "SELECT `ans`, `userans` FROM `p4q1`;";
