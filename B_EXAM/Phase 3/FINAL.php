  					...
  					<div class="col-sm-12">
                        ...
                        <h2><b>Q:</b>Write HTML code to print this- </h2>
							<h4><center>Details:<br>
								<ul>
								<li>Create a rounded corner box with color code #00afef.</li>
								<li>Insert a border image . </li>
								<li>Use linear-gradient(Black,white)</li>
								<li>Show background-image: repeating-radial-gradient(red, yellow 10%, green 15%)</li>
								<li>Text shadow should be of black , blue and darkblue</li>
								<li>Use transitions and animations as shown below.</li>
								</ul></center></h4>
							<h5>&nbsp;</h5>
							<center><video src="images/Practical/phase 3.mp4" autoplay width="1000" controls></video></center>
							<h5>&nbsp;</h5>
							<a href="PHASES/Advance CSS.png">Download image</a>
