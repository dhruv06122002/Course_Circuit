    ...
    <div id="wrapper">
        <div class="main">
                    ...
                    <div class="navbar-collapse">
                       <ul class="nav navbar-nav float-right">
                            <li><a href="../../B_COURSE/1_HTML,CSS,PHP for web-development.html">Home</a></li>
                             <li><a href="../../B_COURSE/B_PHASE_5/PAGE_0.html">Index</a></li>
            ...
            <section class="jumbotron">
                <div class="container">
                    <p><center><img src="PHASES/database.png" height="150" width="150"></center></p>
                    <p class="lead"><center><b><h3>Welcome to Phase 5 : Database(MYSQL)</h3></b></center></p>
                </div>
            </section>
                ...
                <?php 															
																...
																$fetchqry2 = "UPDATE `p5q1` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table class="roundedCorners1" align="center"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `p5q1` where id='$c'"; 
...
<tr align="center"><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
 ...
 <?php if($_SESSION['clicks']>10){ 
	$qry3 = "SELECT `ans`, `userans` FROM `p5q1`;";
