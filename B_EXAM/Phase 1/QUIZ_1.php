        ...
        <div class="main">
            ...
            <section class="jumbotron">
                ...
                <?php 															
																...
																$fetchqry2 = "UPDATE `p1q1` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table class="roundedCorners1" align="center"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `P1Q1` where id='$c'"; 
...
<tr align="center"><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
 ...
 <?php if($_SESSION['clicks']>10){ 
	$qry3 = "SELECT `ans`, `userans` FROM `p1q1`;";
...
<!--img src="images/result.png" height="200" width="400"--><br>
 ...
 if($no<=5)
 {
	 ...
	 <center><a href="QUIZ_1.php">RETRY!!!</a></center>
	 <?php
	 echo "<h4>&nbsp;</h4>";
 }
 else
 {
	echo "<br>";
	 ...
	 <center><a href="FINAL.php">NEXT</a></center>
	 <?php
	 echo "<h4>&nbsp;</h4>";
 }
 ?> </center></span>
