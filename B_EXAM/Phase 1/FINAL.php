            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="S./../B_COURSE/1_HTML,CSS,PHP for web-development.html">
                    ...
                    <div class="navbar-collapse">
                        <ul class="nav navbar-nav float-right">
                            <li><a href="../../B_COURSE/1_HTML,CSS,PHP for web-development.html">Home</a></li>
                             <li><a href="../../B_COURSE/B_PHASE_1/PAGE_0.html">Index</a></li>
             ...
             <section class="jumbotron">
                <div class="container">
                    <p><center><img src="PHASES/HTML.png" height="150" width="150"></center></p>
                    <p class="lead"><center><b><h3>Welcome to Phase 1 : The HTML</h3></b></center></p>
                </div>
            </section>
                ...
                <div class="col-sm-12">
  					...
  					<div class="col-sm-12">
                        ...
                        <h2><b>Q:</b>Write HTML code to print this- </h2>
							<center><img src="images/Practical/practical 1.png" ></center>
							<h5>&nbsp;</h5>
