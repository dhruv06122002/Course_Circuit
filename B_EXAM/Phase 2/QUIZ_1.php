        ...
        <div class="main">
            ...
            <section class="jumbotron">
                ...
                <?php 															
																...
																$fetchqry2 = "UPDATE `p2q1` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table class="roundedCorners1" align="center"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `p2q1` where id='$c'"; 
...
<tr align="center"><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
 ...
 <?php if($_SESSION['clicks']>10){ 
	$qry3 = "SELECT `ans`, `userans` FROM `p2q1`;";
