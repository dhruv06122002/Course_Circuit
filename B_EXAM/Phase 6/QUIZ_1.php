    ...
    <div id="wrapper">
        <div class="main">
                    ...
                    <div class="navbar-collapse">
                       <ul class="nav navbar-nav float-right">
                            <li><a href="../../B_COURSE/1_HTML,CSS,PHP for web-development.html">Home</a></li>
                             <li><a href="../../B_COURSE/B_PHASE_6/PAGE_0.html">Index</a></li>
            ...
            <section class="jumbotron">
                <div class="container">
                    <p><center><img src="PHASES/hosting.png" height="150" width="150"></center></p>
                    <p class="lead"><center><b><h3>Welcome to Phase 6 : Hosting</h3></b></center></p>
                </div>
            </section>
                ...
                <?php 															
																...
																$fetchqry2 = "UPDATE `p6q1` SET `userans`='$userselected' WHERE `id`=$c-1"; 
...
<table class="roundedCorners1" align="center"><?php if(isset($c)) {   $fetchqry = "SELECT * FROM `p6q1` where id='$c'"; 
				$result=mysqli_query($con,$fetchqry);
				$num=mysqli_num_rows($result);
				$row = mysqli_fetch_array($result,MYSQLI_ASSOC); }
		  ?>
<tr class="roundedCorners1" align="center"><td><h3><br><?php echo @$row['que'];?></h3></td></tr> <?php if($_SESSION['clicks'] > 0 && $_SESSION['clicks'] < 11){ ?>
 ...
 <?php if($_SESSION['clicks']>10){ 
	$qry3 = "SELECT `ans`, `userans` FROM `p6q1`;";
 ...
 else
{
	echo "<br>";
	 ...
	 ?><a href="../../C_CERTIFICATE/1_Enter name.html"><h3>GET CERTIFICATE</h3></a>
	 <?php
	 echo "<h4>&nbsp;</h4>";
 }
 ?> </center></span>
